...
## Hotori の教育構造
Hotori を用いた学習では、AIとの対話からデータセットを作成し、SFT（教師あり微調整）によって カスタムAIモデルを作成し配布するところまでを経験できます。

この過程を通じて、学習者は「自分でAIを作ることができた」という強い成功体験を得ることができます。

日本の中小企業では、兼任が当たり前で、例えば「経理兼社内システム管理者」のように複数の業務を担うケースが多く見られます。そのため、営業や経理が本業でありながら、同時にAIモデルを作成できるような 多能工型の人材が求められています。

2008年のリーマンショック以降、多くの企業は自社内で十分な人材育成を行う余裕を持ちにくくなりました。そのため、高校・専門学校・大学などの教育機関において、複数分野のスキルを持つ人材を育成することが期待されています。

社会ではAIを利用する人は増え続けていますが、AIを育成し、モデルを作ることができる人材はまだ希少です。
Hotori は、AIを単に利用するだけではなく、AIを育て、作ることができる人材を育成するための学習環境を提供します。

### Horotiを使った学習
AIを使うだけの人から、AIを育てる・作る人に変わることが中心になります。高校教育においては、社会系科目・国語科目・英語科目などと組み合わせることで、各教科の学習内容を情報技術と結びつけながら理解し、活用できる人材の育成につながります。
