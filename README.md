...
- SDD（仕様駆動開発）で開発のため、[仕様書](https://github.com/kolinz/hotori-local/blob/main/docs/hotori-specification-SDD-v0.2.2.md)付き
...
### Windows 向けアプリを使う場合
- `release-learning-assistant-horori-win-0.2.2.zip` をダウンロードし、Zip ファイルを展開してください。その後、`学習アシスタント Hotori Setup 0.2.0.exe` を実行してください。
