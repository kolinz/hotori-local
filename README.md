...
## なぜ、Hotoriなのか
授業中の学生は、AIチャットで調べても記録を残さないため、
少し時間が経つと内容を忘れてしまいます。
翌週の授業で小テストを行うと、10点満点中1点や3点という結果が続出することも珍しくありません。

AIチャットは便利ですが、記録されない対話は学んだつもりになる「消費型学習」になりやすいという問題があります。

Hotoriは AIとの対話を記録・整理し、予習・復習に活かす仕組みを提供します。表形式のファイルとして出力できるので、デジタルノートツール等に蓄積しても良いでしょう。
